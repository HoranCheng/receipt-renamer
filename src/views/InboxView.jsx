...
import { findOrCreateFolder, listFilesInFolder, getFileAsBase64, renameAndMoveFile, appendToSheet } from '../services/google';
  ...
  return (
    <div style={{padding:"0 16px 100px"}}>
      ...
      <div style={{display:"flex",gap:8,marginBottom:16}}>
        <Btn small onClick={loadInbox} style={{flex:1}}>{"\u{1F504} \u5237\u65B0"}</Btn>
      ...
      {batchMode && (
        <div style={{background:T.accDim,border:`1px solid ${T.accGlow}`,borderRadius:12,
          ...
          <div style={{display:"flex",justifyContent:"space-between",marginBottom:6}}>
            ...
            <span style={{fontSize:12,fontWeight:600,color:T.acc,fontFamily:"'IBM Plex Mono',monospace"}}>
