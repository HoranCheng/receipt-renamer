    ...
    <div style={{ padding: '0 18px 100px' }}>
      ...
      {step === 2 && (
        <div style={{ animation: 'fadeUp 0.3s ease' }}>
          ...
          />
          <Field
            label={'Google Sheets ID\uFF08\u53EF\u9009\uFF09'}
            icon={'\u{1F4CA}'}
            value={config.sheetId}
            onChange={(v) => setConfig((c) => ({ ...c, sheetId: v }))}
            placeholder={'\u7559\u7A7A\u5219\u8DF3\u8FC7 Sheets \u540C\u6B65'}
            mono
          />
          <Field
            label={'Sheet \u5DE5\u4F5C\u8868\u540D'}
